...
Rectangle {
    ...
    function obtenerPresentes() {
        ...
        if (rangoDias > 0) {
            if (!wrapper.managerAsistencias.obtenerPresentesEntreFechas(txtFechaInicial.date, txtFechaFinal.date)) {
                //Mostrar mensajito
            }

            if (!wrapper.managerAsistencias.obtenerPresentesInfantilesEntreFechas(txtFechaInicial.date, txtFechaFinal.date)) {
    ...
    Component.onCompleted: {
        ...
        wrapper.managerAsistencias.obtenerPresentesEntreFechas(wrapper.classManagementManager.obtenerFecha(), wrapper.classManagementManager.obtenerFecha())
    }
